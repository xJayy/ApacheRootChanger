...
def dependencies():
    if sys.platform!="linux1" and sys.platform!="linux2":
...
def applySitesChanges(verbose=False):
    system("clear")
    ...
    output=subprocess.call("a2ensite " + newSiteName,shell=True,stdout=null,stderr=null)
    time.sleep(1)
...
if __name__=="__main__":
    ...
    applySitesChanges(verbose=True)
